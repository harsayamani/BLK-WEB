    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Informasi Akun Balai Latihan Kerja Indramayu</span>
                <table class="main">
                        ...
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hai {{ $nama }}</p>
                                        <p>Terimakasih sudah mendaftar akun BLK </p>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td> <div class="container">
                                                                    <center><p>Kami mengirimkan sejumlah data penting yaitu :</p></center>
                                                                    <hr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td class="content-block powered-by">
                                Balai Latihan Kerja Kaupaten Indramayu
                            </td>
                        </tr>
                    </table>
                </div>
