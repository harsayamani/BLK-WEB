...
<head>
    ...
    <title>Email Konfirmasi Pengubahan Password</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Konfirmasi Pengubahan Password</span>
                <table class="main">
                        ...
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <p>Hai {{ $nama }}</p>
                                        <p>Berikut kami konfirmasikan untuk pengubahan password anda</p>
