...
@section('title', 'Info Lowongan Pekerjaan - Balai Latihan Kerja - Disnaker Kabupaten Indramayu')
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-top clearfix">
                        <h4 class="pull-left">Loker Terbaru<a href="/loker"><i class="fa fa-rss"></i></a></h4>
                    </div><!-- end blog-top -->

                    @foreach ($loker as $kon)
                    <div class="blog-list clearfix">
                        <div class="blog-box row">
                            ...
                            <h4><a href="/loker/{{$kon->kd_loker}}" title="">{{$kon->judul}}</a></h4>
                            <small class="firstsmall"><a class="bg-orange" href="/kontenKategori/{{$kon->kd_minat}}" title="">{{App\Minat::where('kd_minat', $kon->kd_minat)->value('minat')}}</a></small>
